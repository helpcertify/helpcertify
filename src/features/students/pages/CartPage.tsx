              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button
                    ...
                    className="rounded-md border border-red-200 px-2.5 py-1 text-xs font-semibold text-red-500 hover:bg-red-50 disabled:opacity-50 dark:border-red-500/30 dark:hover:bg-red-500/10"
                  >
                    Remove
                  </button>
                </div>
              ...
              {cart.couponCode ? (
                <div className="flex items-center justify-between rounded-lg border border-emerald-500/40 bg-emerald-500/10 px-3 py-2 text-sm">
                  ...
                  <button
                    ...
                    className="rounded-md border border-red-200 px-2.5 py-1 text-xs font-semibold text-red-500 hover:bg-red-50 dark:border-red-500/30 dark:hover:bg-red-500/10"
                  >
                    Remove
                  </button>
                </div>
