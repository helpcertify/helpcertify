  ...
  return (
    <AuthSplitShell>
      <div className="w-full max-w-sm rounded-xl border border-surface-border bg-surface-raised p-8">
        ...
        <h1 className="mb-1 text-center text-xl font-bold text-ink">Create your account</h1>
        <p className="mb-6 text-center text-sm text-ink-faint">Start practicing in a couple of minutes.</p>
        ...
        <form noValidate onSubmit={handleSubmit((values) => mutation.mutate(values))} className="space-y-4">
          ...
          <div>
            <label className="flex items-start gap-2 text-sm text-ink-muted">
              ...
              <span>
                I agree to the{' '}
                <a href="/terms" target="_blank" rel="noopener" className="text-[#2F5FE0] underline">
                  Terms of Service
                </a>{' '}
                and{' '}
                <a href="/privacy" target="_blank" rel="noopener" className="text-[#2F5FE0] underline">
                  Privacy Policy
                </a>
                .
              </span>
        ...
        <p className="mt-4 text-center text-sm text-ink-faint">
          ...
          <Link to="/login" className="font-medium text-[#2F5FE0] underline">
            Log in
          </Link>
        </p>
      </div>
