    ...
    >
      <Section heading="Your consumer rights come first">
        <P>
          ...
          not delivered, you are entitled to a remedy - regardless of the exclusions
      ...
      <Section heading="General rule">
        <P>
          {COMPANY.brand} sells digital exam-preparation content - practice questions,
          answers, explanations, mock examinations, and progress tracking - and access is
      ...
      <Section heading="Circumstances that may be eligible for a refund">
        <UL>
          <li>
            <strong>A. Duplicate or failed payment</strong> - if you are accidentally
          ...
          <li>
            <strong>A1. Payment succeeded but access was not granted</strong> - if your
            payment goes through but the purchased access does not unlock, we will restore it
            immediately; if we cannot, the payment is refunded in full - the service was
            not delivered.
          </li>
          <li>
            <strong>B. Service cannot be provided</strong> - if payment has been received
          ...
          <li>
            <strong>C. A material included feature cannot be delivered</strong> - if we
          ...
          <li>
            <strong>D. Applicable consumer law</strong> - nothing in this policy or in
      ...
      <Section heading="Technical issues">
        <P>
          ...
          first be given a reasonable opportunity to investigate and resolve a reported issue - for example login or OTP problems, questions not loading, answer or
      ...
      <Section heading="Reporting purchase or access problems">
        <P>
          ...
          qualify the purchase for a refund - the 48-hour period is a reporting and
      ...
      <Section heading="Timelines">
        <P>
          ...
          original payment method through {COMPANY.paymentProcessor} within 3-5 business
          days of approval; your bank or card issuer may take a further 5-10 business
