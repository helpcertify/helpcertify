...
export function AdminHomePage() {
  ...
  return (
    <div>
      <div className="mb-1 text-xs uppercase tracking-wide text-neutral-500">Admin Portal</div>
      <h1 className="mb-8 text-2xl font-semibold text-white">Welcome, Admin</h1>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        {ACTIONS.map((action) => (
          ...
          >
            ...
            <p className="text-sm text-neutral-400">{action.body}</p>
          </Link>
        ))}
      </div>
    </div>
