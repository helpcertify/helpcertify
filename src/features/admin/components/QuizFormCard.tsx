    ...
    <div className="rounded-xl border border-surface-border bg-surface-raised p-6">
      <div className="mb-6 flex items-center justify-between">
        ...
        <button
          ...
          className="rounded-lg border border-brand-500 px-3 py-1.5 text-sm text-brand-ink hover:opacity-80"
        >
          ↓ Template
        </button>
      </div>
      ...
      <div className="space-y-5">
        ...
        {!isEditing && (
          <Field label="Upload Quiz File (.docx)">
            <input
              ...
              className="block w-full text-sm text-ink-muted file:mr-3 file:rounded-lg file:border-0 file:bg-brand-500 file:px-3 file:py-2 file:text-sm file:font-medium file:text-white"
            />
          </Field>
        )}
        ...
        <button
          ...
          className="w-full rounded-lg bg-brand-500 py-3 font-medium text-surface disabled:opacity-50"
        >
