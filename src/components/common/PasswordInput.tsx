...
// A plain password <input> with a click-to-reveal eye icon, used everywhere
// a user types a password (login, register, admin access, reset, settings)
// so a mistyped or autofilled-wrong password is easy to spot before submit.
